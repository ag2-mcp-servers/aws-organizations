...
@app.post(
    ...
    tags=['handshake_management', 'organization_structure_management'],
    security=[
...
@app.post(
    ...
    tags=['account_creation_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
def create_gov_cloud_account(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: CreateGovCloudAccountRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    tags=['organization_structure_management', 'account_creation_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['organizational_unit_management', 'organization_structure_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['policy_operations_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['handshake_management', 'account_permission_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['service_access_control_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    description=""" <p>Deletes an organizational unit (OU) from a root or another OU. You must first remove all accounts and child OUs from the OU that you want to delete.</p> <p>This operation can be called only from the organization's management account.</p> """,
    tags=['organizational_unit_management', 'organization_structure_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
def delete_organizational_unit(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: DeleteOrganizationalUnitRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Deletes the specified policy from your organization. Before you perform this operation, you must first detach the policy from all organizational units (OUs), roots, and accounts.</p> <p>This operation can be called only from the organization's management account.</p> """,
    tags=['policy_operations_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
@app.post(
    ...
    description=""" <p>Deletes the resource policy from your organization.</p> <p>You can only call this operation from the organization's management account.</p> """,
    tags=['service_access_control_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
@app.post(
    ...
    tags=['account_permission_management', 'organization_structure_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def deregister_delegated_administrator(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: DeregisterDelegatedAdministratorRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Retrieves Organizations-related information about the specified account.</p> <p>This operation can be called only from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['account_creation_management', 'organization_structure_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
@app.post(
    ...
    description=""" <p>Retrieves the current status of an asynchronous request to create an account.</p> <p>This operation can be called only from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['account_creation_management', 'organization_structure_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
def describe_create_account_status(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: DescribeCreateAccountStatusRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Returns the contents of the effective policy for specified policy type and account. The effective policy is the aggregation of any policies of the specified type that the account inherits, plus any policy of that type that is directly attached to the account.</p> <p>This operation applies only to policy types <i>other</i> than service control policies (SCPs).</p> <p>For more information about policy inheritance, see <a href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies-inheritance.html">How Policy Inheritance Works</a> in the <i>Organizations User Guide</i>.</p> <p>This operation can be called only from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['policy_operations_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
def describe_effective_policy(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: DescribeEffectivePolicyRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Retrieves information about an organizational unit (OU).</p> <p>This operation can be called only from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['organization_structure_management', 'organizational_unit_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def describe_organizational_unit(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: DescribeOrganizationalUnitRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Retrieves information about a policy.</p> <p>This operation can be called only from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['policy_operations_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
@app.post(
    ...
    description=""" <p>Retrieves information about a resource policy.</p> <p>You can only call this operation from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['service_access_control_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
def disable_a_w_s_service_access(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: DisableAWSServiceAccessRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Disables an organizational policy type in a root. A policy of a certain type can be attached to entities in a root only if that type is enabled in the root. After you perform this operation, you no longer can attach policies of the specified type to that root or to any organizational unit (OU) or account in that root. You can undo this by using the <a>EnablePolicyType</a> operation.</p> <p>This is an asynchronous request that Amazon Web Services performs in the background. If you disable a policy type for a root, it still appears enabled for the organization if <a href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_org_support-all-features.html">all features</a> are enabled for the organization. Amazon Web Services recommends that you first use <a>ListRoots</a> to see the status of policy types for a specified root, and then use this operation.</p> <p>This operation can be called only from the organization's management account.</p> <p> To view the status of available policy types in the organization, use <a>DescribeOrganization</a>.</p> """,
    tags=['service_access_control_management', 'policy_operations_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
def enable_a_w_s_service_access(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: EnableAWSServiceAccessRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    tags=['account_permission_management', 'service_access_control_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    description=""" <p>Enables a policy type in a root. After you enable a policy type in a root, you can attach policies of that type to the root, any organizational unit (OU), or account in that root. You can undo this by using the <a>DisablePolicyType</a> operation.</p> <p>This is an asynchronous request that Amazon Web Services performs in the background. Amazon Web Services recommends that you first use <a>ListRoots</a> to see the status of policy types for a specified root, and then use this operation.</p> <p>This operation can be called only from the organization's management account.</p> <p>You can enable a policy type in a root only if that policy type is available in the organization. To view the status of available policy types in the organization, use <a>DescribeOrganization</a>.</p> """,
    tags=['policy_operations_management', 'service_access_control_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
def invite_account_to_organization(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: InviteAccountToOrganizationRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Returns a list of the Amazon Web Services services that you enabled to integrate with your organization. After a service on this list creates the resources that it requires for the integration, it can perform operations on your organization and its accounts.</p> <p>For more information about integrating other services with Organizations, including the list of services that currently work with Organizations, see <a href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_integrate_services.html">Integrating Organizations with Other Amazon Web Services Services</a> in the <i>Organizations User Guide.</i> </p> <p>This operation can be called only from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['service_access_control_management', 'organization_structure_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def list_a_w_s_service_access_for_organization(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: ListAWSServiceAccessForOrganizationRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Lists all of the organizational units (OUs) or accounts that are contained in the specified parent OU or root. This operation, along with <a>ListParents</a> enables you to traverse the tree structure that makes up this root.</p> <note> <p>Always check the <code>NextToken</code> response parameter for a <code>null</code> value when calling a <code>List*</code> operation. These operations can occasionally return an empty set of results even when there are more results available. The <code>NextToken</code> response parameter value is <code>null</code> <i>only</i> when there are no more results to display.</p> </note> <p>This operation can be called only from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['organization_structure_management', 'handshake_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
def list_create_account_status(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: ListCreateAccountStatusRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Lists the Amazon Web Services accounts that are designated as delegated administrators in this organization.</p> <p>This operation can be called only from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['account_permission_management', 'service_access_control_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
def list_delegated_administrators(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: ListDelegatedAdministratorsRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>List the Amazon Web Services services for which the specified account is a delegated administrator.</p> <p>This operation can be called only from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['organization_structure_management', 'account_permission_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
def list_delegated_services_for_account(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: ListDelegatedServicesForAccountRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def list_handshakes_for_account(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: ListHandshakesForAccountRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def list_handshakes_for_organization(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: ListHandshakesForOrganizationRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Lists the organizational units (OUs) in a parent organizational unit or root.</p> <note> <p>Always check the <code>NextToken</code> response parameter for a <code>null</code> value when calling a <code>List*</code> operation. These operations can occasionally return an empty set of results even when there are more results available. The <code>NextToken</code> response parameter value is <code>null</code> <i>only</i> when there are no more results to display.</p> </note> <p>This operation can be called only from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['organization_structure_management', 'organizational_unit_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
@app.post(
    ...
    description=""" <p>Lists the policies that are directly attached to the specified target root, organizational unit (OU), or account. You must specify the policy type that you want included in the returned list.</p> <note> <p>Always check the <code>NextToken</code> response parameter for a <code>null</code> value when calling a <code>List*</code> operation. These operations can occasionally return an empty set of results even when there are more results available. The <code>NextToken</code> response parameter value is <code>null</code> <i>only</i> when there are no more results to display.</p> </note> <p>This operation can be called only from the organization's management account or by a member account that is a delegated administrator for an Amazon Web Services service.</p> """,
    tags=['policy_operations_management', 'organization_structure_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def list_policies_for_target(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: ListPoliciesForTargetRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def list_targets_for_policy(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: ListTargetsForPolicyRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Moves an account from its current source parent root or organizational unit (OU) to the specified destination parent root or OU.</p> <p>This operation can be called only from the organization's management account.</p> """,
    tags=['account_creation_management', 'organization_structure_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
@app.post(
    ...
    description=""" <p>Creates or updates a resource policy.</p> <p>You can only call this operation from the organization's management account.</p> """,
    tags=['policy_operations_management', 'resource_policy_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    description=""" <p>Enables the specified member account to administer the Organizations features of the specified Amazon Web Services service. It grants read-only access to Organizations service data. The account still requires IAM permissions to access and administer the Amazon Web Services service.</p> <p>You can run this action only for Amazon Web Services services that support this feature. For a current list of services that support it, see the column <i>Supports Delegated Administrator</i> in the table at <a href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_integrate_services_list.html">Amazon Web Services Services that you can use with Organizations</a> in the <i>Organizations User Guide.</i> </p> <p>This operation can be called only from the organization's management account.</p> """,
    tags=['account_permission_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def register_delegated_administrator(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: RegisterDelegatedAdministratorRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def remove_account_from_organization(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: RemoveAccountFromOrganizationRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Removes any tags with the specified keys from the specified resource.</p> <p>You can attach tags to the following resources in Organizations.</p> <ul> <li> <p>Amazon Web Services account</p> </li> <li> <p>Organization root</p> </li> <li> <p>Organizational unit (OU)</p> </li> <li> <p>Policy (any type)</p> </li> </ul> <p>This operation can be called only from the organization's management account.</p> """,
    tags=['resource_policy_operations', 'resource_tag_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    description=""" <p>Renames the specified organizational unit (OU). The ID and ARN don't change. The child OUs and accounts remain in place, and any attached policies of the OU remain attached.</p> <p>This operation can be called only from the organization's management account.</p> """,
    tags=['organization_structure_management', 'organizational_unit_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
@app.post(
    ...
    description=""" <p>Updates an existing policy with a new name, description, or content. If you don't supply any parameter, that value remains unchanged. You can't change a policy's type.</p> <p>This operation can be called only from the organization's management account.</p> """,
    tags=['policy_operations_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
